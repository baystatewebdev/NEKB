...
import { CalendarCheck, HouseLine, Swatches } from "@phosphor-icons/react/dist/ssr"
        ...
        <div className="container mx-auto">
          ...
          <ul className="grid gap-8 lg:grid-cols-3">
            <li className="p-4 bg-white border border-black flex flex-col gap-4 items-center text-center lg:text-left lg:items-start">
              <HouseLine size="3.5rem" className="text-primary" />
              <Heading level="h3" levelStyle="h4" className="text-balance">Locally Crafted Products</Heading>
              <p className="text-balance">Our products are locally crafted in the USA for reliability and durability.</p>
            </li>
            <li className="p-4 bg-white border border-black flex flex-col gap-4 items-center text-center lg:text-left lg:items-start">
