...
import { checkLandingPagePath } from "@/helpers";
...
const MainNav = () => {
	...
	const isLandingPage = checkLandingPagePath(pathname);
	...
	const navMenuClasses = isNavActive
		? "before:block before:absolute before:bg-black before:top-0 before:right-full before:opacity-40 before:w-full before:h-full lg:before:hidden"
		: "hidden";
		...
		<div className="border-b border-neutral-100 py-5 relative z-50">
			<div className="container mx-auto">
				<nav className="flex justify-between items-center uppercase">
					<Link href="/" className="tracking-wide leading-tight">
						Northeast
						<br />
						Kitchen / Bath
					</Link>
					...
					<div
						id="main-nav"
						className={`bg-white flex flex-col pl-4 gap-8 absolute top-full right-0 w-10/12 h-dvh lg:items-center lg:gap-16 lg:static lg:h-auto lg:w-auto lg:flex-row ${navMenuClasses}`}
					>
						...
						<ul className="flex flex-wrap gap-4">
							{isLandingPage ? (
								...
								<>
									<li>
										<a
											href="https://www.facebook.com/northestkitchenandbath"
									...
									<li>
										<a
											href="https://www.instagram.com/northeastkitchenbath/"
											className="text-neutral-400"
											target="_blank"
										>
